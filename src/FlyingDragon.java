...
public class FlyingDragon implements Piece {
    ...
    public FlyingDragon(String CurrPlayer, int iRow, int iCol, String[][] Board, String[][] ArrPieces, String[] ArrAllAccessableleSpaces, String[] ArrAllCapturableSpaces) {
    ...
    public void TracePath() {
        ...
        for ( int rowIndx = iRow - 1, colIndx = iCol + 1, count = 1 ; (rowIndx >= 0 && colIndx <= 9 && count <= 2); rowIndx--, colIndx++, count++) {
        ...
        // Moves one row up and one column right simultaneously
        for (int rowIndx = iRow - 1, colIndx = iCol - 1, count = 1; (rowIndx >= 0 && colIndx >= 0 && count <= 2 ) ; rowIndx--, colIndx--, count++) {
            if (!((Board[rowIndx][colIndx]).equals(".")))  {
                //
                //StdOut.println("Piece at: " + rowIndx + ":" + colIndx);
                //
        ...
        // Moves one row up and one column right simultaneously
        for (int rowIndx = iRow + 1, colIndx = iCol + 1, count = 1; (rowIndx <= 9 && colIndx <= 9 && count <= 2 ); rowIndx++, colIndx++, count++) {
            if (!((Board[rowIndx][colIndx]).equals(".")))  {
                //
                //StdOut.println("Piece at: " + rowIndx + ":" + colIndx);
                //
        ...
        // Moves one row up and one column right simultaneously
        for (int rowIndx = iRow + 1, colIndx = iCol - 1, count = 1; (rowIndx <= 9 && colIndx >= 0 && count <= 2); rowIndx++, colIndx--, count++) {
            if (!((Board[rowIndx][colIndx]).equals(".")))  {
                //
                //StdOut.println("Piece at: " + rowIndx + ":" + colIndx);
                //
