...
public class DrunkenSoldier implements Piece {
    ...
    public DrunkenSoldier(String CurrPlayer, int iRow, int iCol, String[][] Board, String[][] ArrPieces, String[] ArrAllAccessableleSpaces, String[] ArrAllCapturableSpaces) {
    ...
    public void TracePath() {
        ...
        for (int colIndx = iCol + 1, count =1 ; (colIndx <= 9 && count <= 1); colIndx++, count++) {
        ...
        // LEFT
        //StdOut.println("LEFT");
        for (int colIndx = iCol - 1, count = 1; (colIndx >= 0 && count <= 1); colIndx--, count++) {
            if (!((Board[iRow][colIndx]).equals(".")))  {
                //
                //StdOut.println("Piece at: " + iRow + ":" + colIndx);
                break;
