...
public class Elephant implements Piece {
    ...
    public Elephant(String CurrPlayer, int iRow, int iCol, String[][] Board, String[][] ArrPieces, String[] ArrAllAccessableleSpaces, String[] ArrAllCapturableSpaces) {
    ...
    public void TracePath() {
        ...
        if (CurrPlayer.equals("w")) {
            //StdOut.println("UP");
            for (int rowIndx = iRow - 1; (rowIndx >= 5 && rowIndx <= 9); rowIndx--) {
            ...
            // PLAYER IS BLACK
            //StdOut.println("UP");
            for (int rowIndx = iRow - 1; (rowIndx <= 4 && rowIndx >= 0) ; rowIndx--) {
                if (!((Board[rowIndx][iCol]).equals("."))) {
                    //
                    //StdOut.println("Piece at: " + rowIndx + ":" + iCol);
                    //
        ...
        //============================================================================================================
        // Right and left remain unrestricted
        //============================================================================================================
        //RIGHT
